...
//		while(square.getX() + square.getWidth() > model.getWidth() || square.getY() + square.getHeight() > model.getHeight()) {
//			model.setSquareDx(0);
//			model.setSquareDy(0);
//		}
		if(square.getX() + square.getWidth() > model.getWidth() || square.getY() + square.getHeight() > model.getHeight()) {
